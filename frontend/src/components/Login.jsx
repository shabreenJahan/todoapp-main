...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.data.user.role === 'admin') {
                ...
                // Set redirectTo to the user dashboard or some other user-specific page
                setRedirectTo('/');
            }
            setRedirectTo(isAdmin ? '/admin' : '/');
    ...
    return (
        <div>
           {userToken && redirectTo && <Navigate to={redirectTo} replace />}
            <section className="login-container">
                <div className="px-6 h-full text-gray-800">
                    <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                        ...
                        id="adminToggle"/><label className="form-check-label" htmlFor="adminToggle">
                    Login as Admin
                </label>
                 </div>
